...
/**
 * V1 questions (from your doc). We’ll refine wording later.
 */
      ...
      <fieldset className="usa-fieldset margin-top-2">
        ...
        <div className="usa-radio">
          <input
            ...
            name="q1"
            value="A"
            required                 // marks the whole radio group as required
            checked={q1 === "A"}
            onChange={() => setQ1("A")}
          />
      ...
      <fieldset className="usa-fieldset margin-top-3">
        ...
        <div className="usa-radio">
          <input
            ...
            onChange={() => setQ2("A")}
          />
          <label className="usa-radio__label" htmlFor="q2a">
        ...
        <div className="usa-radio">
          <input
            ...
            onChange={() => setQ2("B")}
          />
          <label className="usa-radio__label" htmlFor="q2b">
        ...
        <div className="usa-radio">
          <input
            ...
            onChange={() => setQ2("C")}
          />
          <label className="usa-radio__label" htmlFor="q2c">
            C) None of the above
          </label>
        </div>
      </fieldset>
      ...
      <fieldset className="usa-fieldset margin-top-3">
        ...
        <div className="usa-radio">
          <input
            ...
            onChange={() => setQ4("A")}
          />
          <label className="usa-radio__label" htmlFor="q4a">
            A) Yes
          </label>
        </div>
        ...
        <div className="usa-radio">
          <input
            ...
            onChange={() => setQ4("B")}
          />
          <label className="usa-radio__label" htmlFor="q4b">
            B) No
          </label>
        </div>
      </fieldset>

      <div role="status" aria-live="polite" className="margin-top-2">
        {!canSubmit && (
          <p className="usa-hint">Answer all four questions to see your results.</p>
        )}
      </div>
